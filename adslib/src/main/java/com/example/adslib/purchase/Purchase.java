package com.example.adslib.purchase;
...
import com.example.adslib.purchase.function.BillingListener;
import com.example.adslib.purchase.function.PurchaseListioner;
...
public class Purchase {
    ...
    PurchasesUpdatedListener purchasesUpdatedListener = new PurchasesUpdatedListener() {
        @Override
        public void onPurchasesUpdated(@NonNull BillingResult billingResult, List<com.android.billingclient.api.Purchase> list) {
    ...
    public boolean isPurchased() {
        if (listINAPId != null) {
            com.android.billingclient.api.Purchase.PurchasesResult result = billingClient.queryPurchases(BillingClient.SkuType.INAPP);
            if (result.getResponseCode() == BillingClient.BillingResponseCode.OK && result.getPurchasesList() != null) {
                for (com.android.billingclient.api.Purchase purchase : result.getPurchasesList()) {
        ...
        if (listSubcriptionId != null) {
            com.android.billingclient.api.Purchase.PurchasesResult result = billingClient.queryPurchases(BillingClient.SkuType.SUBS);
            if (result.getResponseCode() == BillingClient.BillingResponseCode.OK && result.getPurchasesList() != null) {
                for (com.android.billingclient.api.Purchase purchase : result.getPurchasesList()) {
    ...
    public boolean isPurchased(Context context, String productId) {
        ...
        com.android.billingclient.api.Purchase.PurchasesResult resultINAP = billingClient.queryPurchases(BillingClient.SkuType.INAPP);
        if (resultINAP.getResponseCode() == BillingClient.BillingResponseCode.OK && resultINAP.getPurchasesList() != null) {
            for (com.android.billingclient.api.Purchase purchase : resultINAP.getPurchasesList()) {
                if (purchase.getSkus().contains(productId)) {
                    return true;
                }
            }
        }
        com.android.billingclient.api.Purchase.PurchasesResult resultSubs = billingClient.queryPurchases(BillingClient.SkuType.SUBS);
        if (resultSubs.getResponseCode() == BillingClient.BillingResponseCode.OK && resultSubs.getPurchasesList() != null) {
            for (com.android.billingclient.api.Purchase purchase : resultSubs.getPurchasesList()) {
...
//        }
    ...
    public void consumePurchase(String productId) {
        com.android.billingclient.api.Purchase pc = null;
        com.android.billingclient.api.Purchase.PurchasesResult resultINAP = billingClient.queryPurchases(BillingClient.SkuType.INAPP);
        if (resultINAP.getResponseCode() == BillingClient.BillingResponseCode.OK && resultINAP.getPurchasesList() != null) {
            for (com.android.billingclient.api.Purchase purchase : resultINAP.getPurchasesList()) {
                if (purchase.getSkus().contains(productId)) {
