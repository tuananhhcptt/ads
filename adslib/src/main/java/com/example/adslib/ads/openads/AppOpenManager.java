...
public class AppOpenManager implements LifecycleObserver, Application.ActivityLifecycleCallbacks {
    ...
    private final OpenAdsApplication myApplication;
    ...
    /** Constructor */
    public AppOpenManager(OpenAdsApplication myApplication, String adsID) {
    ...
    public void onStart() {
        if (AdsInterstitial.isShowing || Purchase.getInstance().isPurchased()) {
            return;
        }
        showAdIfAvailable();
